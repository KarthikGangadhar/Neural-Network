...
if __name__ == "__main__":
    ...
    # print("test_add_input_layer()")
    # test_append_conv2d_layer()
    # print("test_append_conv2d_layer()")
    # test_append_maxpooling2d_layer()
    # print("test_append_maxpooling2d_layer()")
    # test_add_flatten_layer()
    # print("test_add_flatten_layer()")
    # test_append_dense_layer()
    # print("test_append_dense_layer()")
    # test_get_weights_without_biases_1()
    # print("test_get_weights_without_biases_1()")
    # test_get_weights_without_biases_2()
    # print("test_get_weights_without_biases_2()")
    # test_get_weights_without_biases_3()
    # print("test_get_weights_without_biases_3()")
    # test_get_biases_1()
    # print("test_get_biases_1()")
    # test_get_biases_2()
